            ...
            <div class="postwrite-img-map-content">
                                    ...
                                    <div class="image-view-list-content">
                                        <div class="info-bx">
                                            <div class="option-bx">
                                                ...
                                                <div class="move-bx">
                                                    <a class="prev-move btn" @click="prevMove( index )" href="javascript:;">← 사진 순서 뒤로</a>
                                                    <a class="next-move btn" @click="nextMove( index )" href="javascript:;">사진 순서 앞으로 →</a>
                                                </div>
                                            </div>
                ...
                <div class="map-content">
                    <div class="map-container">
                        <GmapMap class="gmap-container" ref="mapRef" :center="mapCenter" :zoom="17" style="width:100%; height:720px">
